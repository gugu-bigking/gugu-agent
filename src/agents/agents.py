...
from agents.gugu_agent import gugu_agent
...
agents: dict[str, Agent] = {
    ...
    "gugu-agent": Agent(
        description=(
            "Gugu: hybrid RAG (BM25 + dense) with cross-encoder reranking, plus web search."
        ),
        graph_like=gugu_agent,
    ),
}
